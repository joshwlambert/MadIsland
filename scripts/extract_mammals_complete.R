...
saveRDS(
  ...
  file = "inst/extdata/mammal_island_tbl_complete.rds"
)

# 2) the DAISIE data table
saveRDS(
  object = daisie_datatable_complete,
  file = "inst/extdata/mammal_daisie_datatable_complete.rds"
)

# 3) the DAISIE data list
saveRDS(
  object = daisie_data_list_complete,
  file = "inst/extdata/mammal_daisie_data_list_complete.rds"
)
